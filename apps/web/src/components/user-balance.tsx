...
const CUSD_ADDRESS = "0xcebA9300f2b948710d2653dD7B07f33A8B32118C"; // native USDC on Celo Mainnet
    ...
    <Card className="w-full max-w-md mx-auto mb-8">
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2 pt-2 border-t">
          ...
          <BalanceDisplay address={address} token={CUSD_ADDRESS as `0x${string}`} symbol="USDC" refetchTrigger={refetchTrigger} />
